...
#define PARIVERSION "GP/PARI CALCULATOR Version 2.15.4 (released)"
#define PARIINFO "amd64 running linux (x86-64/GMP-%s kernel) 64-bit version"
#define PARI_VERSION_CODE 134916
...
#define GCC_VERSION "gcc version 9.4.0 (Ubuntu 9.4.0-1ubuntu1~20.04.2)"
#define ASMINLINE
