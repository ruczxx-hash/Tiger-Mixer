...
\fun{GEN}{ZX_squff}{GEN T, GEN *E} write $T(x)$ as a product $\prod T_i^{e_i}$
...
as a \typ{VECSMALL}. For efficiency, powers of $x$ should have been removed
from $T$ using \kbd{ZX\_valrem}, but the result is also correct if not.
Not memory clean.
