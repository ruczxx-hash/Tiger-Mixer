...
main (int argc, char *argv[])
{
  ...
  success &= check (randgen, SecLevel::_112, k, 20);
  success &= check (randgen, SecLevel::_112, 1100, 20); /* large message */
  success &= check (randgen, SecLevel::_128, k, 15);
  success &= check (randgen, SecLevel::_192, k, 3);
