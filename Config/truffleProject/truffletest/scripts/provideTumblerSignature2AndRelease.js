...
module.exports = async function (callback) {
  try {
    ...
    console.log('[DEBUG] provideTumblerSignature2AndRelease params:', {
      contractAddr,
    ...
    const tx = await inst.provideTumblerSignature2AndRelease(toBytes32(escrowId), signature, { from: fromAddr });
