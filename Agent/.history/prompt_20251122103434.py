...
judger_output_format_prompt = [Based on the above sequence, determine whether the user is suspected of money laundering. If you think they are, output 1; if not, output 0. Don't output anything else.]