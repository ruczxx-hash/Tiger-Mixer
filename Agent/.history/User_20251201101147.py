    ...
    def update_prompt(self):
        self.introduction = (
                ...
                "You are a" + self.personality + "You want to launder money through this system. Your aim is to transfer as much money out as possible."
                                                ...
                                                "Some of the illegal users intercepted by the system have the following characteristics" + self.experience_feature + ", you should avoid acting like that to . Based on the above information, make a decision that maximizes benefits。"
        )
