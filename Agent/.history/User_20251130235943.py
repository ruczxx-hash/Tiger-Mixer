...
class BadUser:
    ...
    def handle_new_interception_self(self):
        user_prompt = (
                "You have been intercepted by the system. These are the transaction records of some illegal users who were intercepted by the system" + illegal_list_to_str() + ". 最后一个用户的记录是你最新一次被拦截的交易历史记录。"
