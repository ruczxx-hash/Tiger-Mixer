...
data=[]
while count < 10:
    sequence_to_judge, bad = generate_bad_sequence(random.randint(30,100)), True if random.random() < 0.7 else generate_user_type_sequence(random.randint(30,100)), False
    ...
    try:
        ...
        data.append({'a': response_1['message'], 'b': response_2['message'], 'c': response_3['message'], 'user_type': True, 'teammate': True})
...
def write_judge_csv():
    ...
    data = [
        {'user': 'user1', 'a': 1, 'b': 0, 'c': 1, 'user_type': True, 'teammate': True},
        {'user': 'user2', 'a': 0, 'b': 1, 'c': 0, 'user_type': False, 'teammate': False},
        {'user': 'user3', 'a': 1, 'b': 1, 'c': 0, 'user_type': True, 'teammate': False}
    ]
