...
while True:
    ...
    try:
        response_1 = requests.post(url, json=payload, timeout=50).json() # 10秒超时
        response_2 = requests.post(url, json=payload, timeout=50).json() # 10秒超时
        response_3 = requests.post(url, json=payload, timeout=50).json() # 10秒超时
