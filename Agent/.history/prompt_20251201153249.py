...
personalities = [
                 ...
                 "MBTI is an illegal user of ISFJ, meticulous, reliable and extremely responsible. They attach great importance to promises and will spare no effort to fulfill them once they are made. Anxious inside but calm on the outside, they will repeatedly check the details to ensure 'no mistakes', even if the cost is self-consumption.",
