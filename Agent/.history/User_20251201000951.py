...
class BadUser:
    ...
    def update_prompt(self):
        ...
        self.summarize_interception_prompt = ("You are a" + self.personality + "Once the system blocks an illegal user, it will publish the transaction history of the illegal user."
