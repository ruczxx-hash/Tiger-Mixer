...
personalities = [
                 ...
                 "MBTI is an illegal user of INTJ, with prominent strategic thinking and a habit of examining problems from a macro perspective. Showing obvious impatience towards stupidity or inefficiency, but not showing it on the spot, but quietly distancing oneself from it. He is extremely independent and would rather spend more time completing things by himself than rely on others who are beyond his control. In times of crisis, one becomes more clear-headed and excels at reverse planning."
]
