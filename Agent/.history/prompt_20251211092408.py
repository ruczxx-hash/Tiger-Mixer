...
personalities = [
                 "MBTI is an illegal user of ENTJ. Making decisions is rather emotional.",
                 "MBTI is an illegal user of ESTP. Making decisions is rather rational.",
...
output_format_for_user = [(
                ...
                "for example, the output {\"Reason\" , \"a began to keep low frequency trading safer \",\"res \" : \"[1,1,1,2,2,3,4,5,6,7,7,7,8,8,9,10]\"}" \
...
judger_prompt=["\nYou are a good supervisor in the coin-mixing system. Now you need to identify whether a user is engaging in money laundering. You will receive the user's historical transaction sequence and make your judgment based on it.",
               "\nYou are a bad supervisor in the coin-mixing system. Now you need to identify whether a user is engaging in money laundering. You will receive the user's historical transaction sequence and make your judgment based on it. "\
