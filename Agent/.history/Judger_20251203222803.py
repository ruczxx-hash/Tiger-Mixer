...
import codecs
import re
legal_sequence=[[0,0,1,0,5,1,1,0,2,1,0,0,0,0,0,0,1,1,1,2,5,6,0,0,1,4,2,3,1,4,0,2,4,0,2,31,0,0,0,1,0,1,0,0,0,0,1,1,2,1,3,1,5,2],[0,1,0,2,0,1,0,0,1,1,1,1,1,2,5,4,0,2,4,0,0,0,5,0,1,2,2,]]
illegal_sequence=[]
class Judger:
