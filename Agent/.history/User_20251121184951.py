    ...
    def call_llm(self, addition_info):
        if self.is_rule:
            ...
            if config.output_type == 1:
                user_prompt = user_prompt + output_format_without_explain
            else:
                user_prompt = user_prompt + output_format_with_explain
