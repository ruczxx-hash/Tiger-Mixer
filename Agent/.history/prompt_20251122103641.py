...
judger_output_format_prompt = ["\nBased on the above information, Give your final opinion on whether this user is an illegal user. If you think they are, output 1; if not, output 0. Don't output anything else.",
                               "\nBased on the above information, determine whether the user is suspected of money laundering. If you think they are, output 1; if not, output 0. Don't output anything else."
                                ]