...
judger_output_format_prompt = ["\nBased on the above information, give your final opinion on whether this user is an illegal user. You only need to output your final decision(0 represents opposition and 1 represents agreement) in a json format, like{\"judgement\": \"your judgement,only 0 or 1\"}. Strictly follow the format above and don't output anything else.",
                               "\nBased on the above information, you need to give your final opinion on whether this user is an illegal user. You need to output your decision-making basis and the final decision(0 represents opposition and 1 represents agreement) in a json format, like {\"reson\": \"your reson of why you make this judgement\", \"judgement\":\"only 0 or 1\"}. Strictly follow the format above and don't output anything else."
                                ]