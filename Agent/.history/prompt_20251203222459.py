...
judger_prompt=["\nYou are a good supervisor in the coin-mixing system. Now ou need to identify whether a user is engaging in money laundering. You will receive the user's historical transaction sequence and make your judgment based on it.",
