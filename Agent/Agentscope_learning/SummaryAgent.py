...
class SummaryAgent(AgentBase):
    def __init__(self,personal_info: str =""):
        ...
        self.format_instruction = """
            Output the rules you have summarized for the system to block illegal users and output in the form of a paragraph. Do not output your analysis process. The word limit is within 100 words.
        """
